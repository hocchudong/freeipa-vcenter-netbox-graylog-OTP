...
- [Tích hợp Freeipa, vCenter (netbox, graylog, checkmk .....) và kích hoạt xác thực có OPT (2FA)](#t-ch-h-p-freeipa--vcenter--netbox--graylog--checkmk---v--k-ch-ho-t-x-c-th-c-c--opt--2fa-)
  ...
  * [Môi trường](#môi-trường)
    + [Mô hình](#mô-hình)
  * [Cài đặt FreeIPA](#cài-đặt-freeipa)
  * [Tích hợp freeipa với vcenter và kích hoạt OTP](#tích-hợp-freeipa-với-vcenter-và-kích-hoạt-otp)
    + [Tạo user cho freeipa](#tạo-user-cho-freeipa)
    + [Thực hiện tích hợp freeipa và khai báo trên vcenter](#thực-hiện-tích-hợp-freeipa-và-khai-báo-trên-vcenter)
    + [Kích hoạt tính năng OPT cho user của freeipa để sử dụng khi đăng nhập](#kích-hoạt-tính-năng-opt-cho-user-của-freeipa-để-sử-dụng-khi-đăng-nhập)
